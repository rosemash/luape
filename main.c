...
volatile const int MAGIC_POINTER = 0x13371337; // this is a placeholder, it should be be updated after compilation to point to the script
...
int main(int argc, char* argv[]) {
	...
	luaL_loadbuffer(L, source, size, "=loader");
